<template>
  <el-dialog :model-value="visible" title="批量清理日志" width="480px" @update:model-value="emit('update:visible', $event)">
    <div class="prune-form">
      <p class="prune-hint">仅保留最近若干条日志，超过部分按请求时间从早到晚删除。</p>
      <el-form label-position="top">
        <el-form-item label="保留条数">
          <el-input-number :model-value="keepCount" :min="0" :step="1000" style="width: 160px" @update:model-value="emit('update:keepCount', $event)" />
        </el-form-item>
